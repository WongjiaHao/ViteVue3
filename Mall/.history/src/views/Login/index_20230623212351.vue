...
const handleLogin = async (formEl) => {
  ...
  await formEl.validate( async (valid, fields) => {
    if (!valid) {
      ...
      const { msg } = res 
      if(msg!=='操作成功') proxy.$showMsg('error', '登录失败，请重试')
      proxy.$showMsg("success", '登录成功')
    }
  })
}
</script>
        ...
        <div class="account-box">
          <div class="form">
            ...
            >
              ...
              <el-button size="large" class="subBtn" @click="handleLogin(loginForm)"
                >点击登录</el-button
              >
            </el-form>
          </div>
