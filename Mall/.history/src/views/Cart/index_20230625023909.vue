      ...
      <div class="cart">
        <table>
          <thead>
            <tr>
              <th width="120">
                <el-checkbox :model-value="cartStore.selectAll" @change="(changevalue)=>{cartStore.selectedSwitch(changevalue);
                }"/>
              </th>
          ...
          <tbody>
            <!-- <el-checkbox-group v-model="checkList"> -->
              <tr v-for="i in cartList" :key="i.id">
                <td>
                  <el-checkbox :model-value = 'i.selected' @change="(changevalue)=>{cartStore.singleCheck(changevalue);
                }"/>
                </td>
                <td>
                  <div class="goods">
