 ...
 * @LastEditTime: 2023-06-23 03:22:57
...
const buildTree = (UnBuild) =>{
    for(const item of UnBuild){ // 我自己的id 
        const selfid = item?.id; // 从source当中过滤去自己的子代 
        const children = UnBuild.filter(subitem=> subitem.parent?.id == selfid); 
        if(children) item.children = children; 
    } 
    let tree = UnBuild.filter(item=>item?.parent === null); 
    return tree
}
</script>
    ...
    <div class="container">
      ...
      <div class="bread-container">
        <el-breadcrumb separator=">">
          ...
          <el-breadcrumb-item :to="{ path: `/category/${categoryTree[0]?.id}` }">{{categoryTree[0]?.name}}
          </el-breadcrumb-item>
          <el-breadcrumb-item :to="{ path: `/category/subCate/${categoryTree[0]?.children[0]?.id}` }">{{categoryTree[0]?.children[0]?.name}}
          </el-breadcrumb-item>
      ...
      <div class="info-container">
        <div>
          <div class="goods-info">
            <div class="media">
              <!-- 图片预览区 -->
                <imageView :image-list="["https://yanxuan-item.nosdn.127.net/ae521f6d97560598f3e6b3ddaed477c0.png"]"></imageView>
              <!-- 统计数量 -->
            ...
            <div class="goods-article">
              ...
              <div class="goods-tabs">
                ...
                <div class="goods-detail">
                  ...
                  <!-- 图片 -->
                    <img v-img-lazy ='it'  v-for=" it in detailData?.details?.pictures" :key = 'it'/>
                </div>
              </div>
            </div>
            <!-- 24热榜+专题推荐 -->
