 ...
 * @LastEditTime: 2023-06-24 22:03:52
...
const addToCart = async ()=>{
  if (!skuObj.skuId) {
    ...
    proxy.$showMsg('warning','添加失败,请选择')   
  }else{
    proxy.$showMsg('success','添加成功')
  }
}
</script>
    ...
    <div class="container">
      ...
      <div class="bread-container">
        <el-breadcrumb separator=">">
          ...
          <el-breadcrumb-item :to="{ path: `/category/${categoryTree[0]?.id}` }"
            >{{ categoryTree[0]?.name }}
          </el-breadcrumb-item>
          <el-breadcrumb-item
            :to="{ path: `/category/subCate/${categoryTree[0]?.children[0]?.id}` }"
            >{{ categoryTree[0]?.children[0]?.name }}
          </el-breadcrumb-item>
        ...
        <div>
          <div class="goods-info">
            ...
            <div class="spec">
              ...
              <!-- sku组件 -->
              <XXTT :goods="detailData" @change="skuChange" />
              <!-- 数据组件 -->
