 ...
 * @LastEditTime: 2023-06-21 20:18:09
...
<template>
  <div class="container">
    ...
    <div class="sub-container">
      ...
      <div class="body" v-infinite-scroll="load" :infinite-scroll-disabled="disabled" v-loading="disabled">
        <!-- 商品列表-->
        <GoodsItem v-for="good in goodList" :good="good" :key="good?.id"></GoodsItem>
        <div v-if="!disabled" style="margin: 0 auto;">Loading</div>
      </div>
    </div>
  </div>
</template>
